...
void gestaodeconta(){
	...
	case 4:
		...
		//condição composta
		if(numconta==numerosaleatorios){
			printf("\n\tDébito|-|%d/%d/%d|%f",data_hora_actual->tm_mday,data_hora_actual->tm_mon+1,data_hora_actual->tm_year+1900,levantamento);
		}
		else{
	...
	case 5:
		...
		printf("\n\tInsira o  Nº de conta a transfêrir:");scanf("%d",&numconta_segundo);
